...
import { assassinate, conversion, coup, embezzlement, examine, exchange1, exchange2, foreignAid, income, steal, tax } from "./rule";



    const actions=['Tax','Assassinate','Steal','Exchange 2 cards','Exchange 1 card','Examine'];
    const blocks=['Blocks Foreign Aid','Blocks Stealing','Blocks Assassination'];
    const character=['Duke','Assassin','Captain','Ambassador','Contessa','Inquisitor'];
    const Duke={
        img:'https://coup-1328751369.cos.ap-guangzhou.myqcloud.com/duke.jpg',
        name:character[0],
        actions:actions[0],
        explain:'从银行获取3块钱',
        act:tax,
    ...
    const commonActions=[incomeCharacter,foreignAidCharacter,coupCharacter,conversionCharacter,embezzlementCharacter];
